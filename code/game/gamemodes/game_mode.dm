...
/datum/game_mode/proc/declare_completion()
	...
	send2mainirc("����� � ������� [src.name] ��������. ��������: [surviving_total]; ���������: [ghosts]; �������: [clients]; �����������������: [roundduration2text()].")
	send2maindiscord("����� � ������� [src.name] ��������. ��������: [surviving_total]; ���������:  [ghosts]; �������: [clients]; �����������������: [roundduration2text()].")
